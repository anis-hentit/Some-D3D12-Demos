...
bool TreeBillboardsApp::Initialize()
{
	...
	mEX1->Execute(mCommandList.Get(), mComputeRootSignature.Get(), mPSOs["Ex1Pso"].Get(), mSrvDescriptorHeap);
    BuildLandGeometry();
    BuildWavesGeometry();
	BuildBoxGeometry();
...
void TreeBillboardsApp::LoadTextures()
{
	...
	grassTex->Filename = L"E:\\Desktop\\frank d luna d3d 12 chapters\\d3d12book-master\\Textures\\grass.dds";
	...
	waterTex->Filename = L"E:\\Desktop\\frank d luna d3d 12 chapters\\d3d12book-master\\Textures\\water1.dds";
	ThrowIfFailed(DirectX::CreateDDSTextureFromFile12(md3dDevice.Get(),
	...
	treeArrayTex->Filename = L"E:\\Desktop\\frank d luna d3d 12 chapters\\d3d12book-master\\Textures\\treeArray2.dds";
	ThrowIfFailed(DirectX::CreateDDSTextureFromFile12(md3dDevice.Get(),
	...
	auto circleTex = std::make_unique<Texture>();
	circleTex->Name = "circle";
	circleTex->Filename = L"E:\\Desktop\\frank d luna d3d 12 chapters\\d3d12book-master\\Textures\\white1x1.dds";
	ThrowIfFailed(DirectX::CreateDDSTextureFromFile12(md3dDevice.Get(),
		mCommandList.Get(), circleTex->Filename.c_str(),
		circleTex->Resource, circleTex->UploadHeap));

	
	mTextures[grassTex->Name] = std::move(grassTex);
	mTextures[waterTex->Name] = std::move(waterTex);
	mTextures[fenceTex->Name] = std::move(fenceTex);
	mTextures[circleTex->Name] = std::move(circleTex);
...
void TreeBillboardsApp::BuildRootSignature()
{
	...
	ComPtr<ID3DBlob> CSerrorBlob = nullptr;
	HRESULT CShr = D3D12SerializeRootSignature(&CompRootSigDesc, D3D_ROOT_SIGNATURE_VERSION_1,
...
void TreeBillboardsApp::BuildDescriptorHeaps()
{
	...
	auto circleTex = mTextures["circle"]->Resource;
	...
	srvDesc.Format = circleTex->GetDesc().Format;
	md3dDevice->CreateShaderResourceView(circleTex.Get(), &srvDesc, hDescriptor);
	...
	// for blur
	CD3DX12_GPU_DESCRIPTOR_HANDLE GpuhDescriptor(mSrvDescriptorHeap->GetGPUDescriptorHandleForHeapStart());
...
void TreeBillboardsApp::BuildShadersAndInputLayouts()
{
	...
	mShaders["standardVS"] = d3dUtil::CompileShader(L"E:\\Desktop\\frank d luna d3d 12 chapters\\d3d12book-master\\my demos\\Chapter 12 The Geometry Shader blur\\TreeBillboards\\Shaders\\Default.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"E:\\Desktop\\frank d luna d3d 12 chapters\\d3d12book-master\\my demos\\Chapter 12 The Geometry Shader blur\\TreeBillboards\\Shaders\\Default.hlsl", defines, "PS", "ps_5_0");
	mShaders["alphaTestedPS"] = d3dUtil::CompileShader(L"E:\\Desktop\\frank d luna d3d 12 chapters\\d3d12book-master\\my demos\\Chapter 12 The Geometry Shader blur\\TreeBillboards\\Shaders\\Default.hlsl", alphaTestDefines, "PS", "ps_5_0");
	
	mShaders["treeSpriteVS"] = d3dUtil::CompileShader(L"E:\\Desktop\\frank d luna d3d 12 chapters\\d3d12book-master\\my demos\\Chapter 12 The Geometry Shader blur\\TreeBillboards\\Shaders\\TreeSprite.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["treeSpriteGS"] = d3dUtil::CompileShader(L"E:\\Desktop\\frank d luna d3d 12 chapters\\d3d12book-master\\my demos\\Chapter 12 The Geometry Shader blur\\TreeBillboards\\Shaders\\TreeSprite.hlsl", nullptr, "GS", "gs_5_0");
	mShaders["treeSpritePS"] = d3dUtil::CompileShader(L"E:\\Desktop\\frank d luna d3d 12 chapters\\d3d12book-master\\my demos\\Chapter 12 The Geometry Shader blur\\TreeBillboards\\Shaders\\TreeSprite.hlsl", alphaTestDefines, "PS", "ps_5_0");

	mShaders["CircleVS"] = d3dUtil::CompileShader(L"E:\\Desktop\\frank d luna d3d 12 chapters\\d3d12book-master\\my demos\\Chapter 12 The Geometry Shader blur\\TreeBillboards\\Shaders\\Circle.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["CircleGS"] = d3dUtil::CompileShader(L"E:\\Desktop\\frank d luna d3d 12 chapters\\d3d12book-master\\my demos\\Chapter 12 The Geometry Shader blur\\TreeBillboards\\Shaders\\Circle.hlsl", nullptr, "GS", "gs_5_0");
	mShaders["CirclePS"] = d3dUtil::CompileShader(L"E:\\Desktop\\frank d luna d3d 12 chapters\\d3d12book-master\\my demos\\Chapter 12 The Geometry Shader blur\\TreeBillboards\\Shaders\\Circle.hlsl", alphaTestDefines, "PS", "ps_5_0");

	mShaders["SphereVS"] = d3dUtil::CompileShader(L"E:\\Desktop\\frank d luna d3d 12 chapters\\d3d12book-master\\my demos\\Chapter 12 The Geometry Shader blur\\TreeBillboards\\Shaders\\sphere.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["SphereGS"] = d3dUtil::CompileShader(L"E:\\Desktop\\frank d luna d3d 12 chapters\\d3d12book-master\\my demos\\Chapter 12 The Geometry Shader blur\\TreeBillboards\\Shaders\\sphere.hlsl", nullptr, "GS", "gs_5_0");
	mShaders["SpherePS"] = d3dUtil::CompileShader(L"E:\\Desktop\\frank d luna d3d 12 chapters\\d3d12book-master\\my demos\\Chapter 12 The Geometry Shader blur\\TreeBillboards\\Shaders\\sphere.hlsl", alphaTestDefines, "PS", "ps_5_0");
...
{
	const UINT numSlices = 26;

	
	const UINT vertexCount = 34;
	...
	for (UINT i = 0; i < vertexCount; ++i)
	{
		...
		vertices[i].Pos = XMFLOAT3(x, 3.0f, z);
	...
	ThrowIfFailed(D3DCreateBlob(sizeof(Vertex)*vertexCount, &geo->VertexBufferCPU));
	CopyMemory(geo->VertexBufferCPU->GetBufferPointer(), vertices, sizeof(Vertex) * vertexCount);


	geo->VertexBufferGPU = d3dUtil::CreateDefaultBuffer(md3dDevice.Get(),
		mCommandList.Get(), vertices, sizeof(Vertex) * vertexCount, geo->VertexBufferUploader);


	geo->VertexByteStride = sizeof(Vertex);
	geo->VertexBufferByteSize = sizeof(Vertex)*vertexCount;
	geo->IndexFormat = DXGI_FORMAT_R16_UINT;
...
void TreeBillboardsApp::BuildSphereGeometry()
{
	...
	GeometryGenerator::MeshData sphere = gen.CreateGeosphere(4.0f,0);
	...
	std::vector<uint32_t> indices =sphere.Indices32;
...
void TreeBillboardsApp::BuildPSOs()
{
	...
	D3D12_GRAPHICS_PIPELINE_STATE_DESC opaquePsoDescCircle = opaquePsoDesc;
	opaquePsoDescCircle.VS =
	{
		reinterpret_cast<BYTE*>(mShaders["CircleVS"]->GetBufferPointer()),
		mShaders["CircleVS"]->GetBufferSize()
	};

	opaquePsoDescCircle.GS =
	{
		reinterpret_cast<BYTE*>(mShaders["CircleGS"]->GetBufferPointer()),
		mShaders["CircleGS"]->GetBufferSize()
	};
	opaquePsoDescCircle.PS =
	{
		reinterpret_cast<BYTE*>(mShaders["CirclePS"]->GetBufferPointer()),
		mShaders["CirclePS"]->GetBufferSize()
	};

	opaquePsoDescCircle.RasterizerState.CullMode = D3D12_CULL_MODE_NONE;
	opaquePsoDescCircle.RasterizerState.FillMode = D3D12_FILL_MODE_WIREFRAME;
	opaquePsoDescCircle.PrimitiveTopologyType = D3D12_PRIMITIVE_TOPOLOGY_TYPE_LINE;
	ThrowIfFailed(md3dDevice->CreateGraphicsPipelineState(&opaquePsoDescCircle, IID_PPV_ARGS(&mPSOs["opaqueCircle"])));



	D3D12_GRAPHICS_PIPELINE_STATE_DESC opaquePsoDescSphere = opaquePsoDesc;

	opaquePsoDescSphere.VS =
	{
		reinterpret_cast<BYTE*>(mShaders["SphereVS"]->GetBufferPointer()),
		mShaders["SphereVS"]->GetBufferSize()
	};

	opaquePsoDescSphere.GS =
	{
		reinterpret_cast<BYTE*>(mShaders["SphereGS"]->GetBufferPointer()),
		mShaders["SphereGS"]->GetBufferSize()
	};
	opaquePsoDescSphere.PS =
	{
		reinterpret_cast<BYTE*>(mShaders["SpherePS"]->GetBufferPointer()),
		mShaders["SpherePS"]->GetBufferSize()
	};

	//opaquePsoDescSphere.RasterizerState.FillMode = D3D12_FILL_MODE_SOLID;
	ThrowIfFailed(md3dDevice->CreateGraphicsPipelineState(&opaquePsoDescSphere, IID_PPV_ARGS(&mPSOs["opaqueSphere"])));
	...
	HorzBlurPsoDesc.pRootSignature = mComputeRootSignature.Get();
	...
	ThrowIfFailed(md3dDevice->CreateComputePipelineState(&HorzBlurPsoDesc, IID_PPV_ARGS(&mPSOs["HorzBlurPso"])));



	D3D12_COMPUTE_PIPELINE_STATE_DESC VertBlurPsoDesc = {};
	VertBlurPsoDesc.pRootSignature = mComputeRootSignature.Get();
	...
	ThrowIfFailed(md3dDevice->CreateComputePipelineState(&VertBlurPsoDesc, IID_PPV_ARGS(&mPSOs["VertBlurPso"])));

	D3D12_COMPUTE_PIPELINE_STATE_DESC Ex1PsoDesc = {};
	Ex1PsoDesc.pRootSignature = mComputeRootSignature.Get();
	Ex1PsoDesc.CS = { reinterpret_cast<BYTE*>(mShaders["Ex1CS"]->GetBufferPointer()),mShaders["Ex1CS"]->GetBufferSize()
	};
	Ex1PsoDesc.Flags = D3D12_PIPELINE_STATE_FLAG_NONE;
...
void TreeBillboardsApp::BuildRenderItems()
{
	...
	sphereRitem->ObjCBIndex = 5;
	sphereRitem->Mat = mMaterials["circle"].get();
